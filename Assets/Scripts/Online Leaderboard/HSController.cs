...
public class HSController : MonoBehaviour
{
    ...
    string addScoreURL = "kingofmadagascar.bplaced.net/addscore.php?"; //be sure to add a ? to your url
    public string highscoreURL = "kingofmadagascar.bplaced.net/display.php?";
    string getCurrentScoreURL = "kingofmadagascar.bplaced.net/getCurrentScore.php?";
    string getCurrentPasswordURL = "kingofmadagascar.bplaced.net/getCurrentPassword.php?";
    ...
    IEnumerator PostScores()
    {
        ...
        string post_url = addScoreURL + "password=" + password + "&name=" + WWW.EscapeURL(name3) + "&score=" + score + "&hash=" + hash;
